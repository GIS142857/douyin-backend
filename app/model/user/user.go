...
func (v *VideoModel) GetMyPrivateVideo(Uid, pageNo, pageSize int64) (slice []Video, total int64) {
	sql1 := `
		SELECT 
			a.aweme_id,
			a.video_desc,
...
func (v *VideoModel) GetMyLikeVideo(Uid, pageNo, pageSize int64) (slice []Video, total int64) {
	sql1 := `
		SELECT 
			a.aweme_id,
			a.video_desc,
...
func (v *VideoModel) GetMyCollectVideo(Uid, pageNo, pageSize int64) (slice []Video, total int64) {
	sql1 := `
		SELECT 
			a.aweme_id,
			a.video_desc,
